 ...
 * The sbox scroll bar.
 */
public interface SboxScrollBar
{
  /**
   * Add a listener.
   * @param lis listener to add.
   */
  public void addSboxScrollBarListener(SboxScrollBarListener lis);

  /**
   * Remove a listener.
   * @param lis listener to remove.
   */
  public void removeSboxScrollBarListener(SboxScrollBarListener lis);
